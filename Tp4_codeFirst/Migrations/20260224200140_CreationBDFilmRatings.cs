...
namespace Tp4_codeFirst.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    utl_cp = table.Column<string>(type: "char(5)", fixedLength: true, maxLength: 5, nullable: true),
                    ...
                    utl_datecreation = table.Column<DateTime>(type: "date", nullable: false, defaultValueSql: "CURRENT_DATE")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ck_not_note_0_5", "not_note >= 0 AND not_note <= 5");
                    table.ForeignKey(
                        name: "fk_not_flm",
                        column: x => x.flm_id,
