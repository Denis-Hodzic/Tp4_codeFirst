...
namespace Tp4_codeFirst.Migrations
{
    ...
    [Migration("20260224200140_CreationBDFilmRatings")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tp4_codeFirst.Models.EntityFramework.Film", b =>
                {
            ...
            modelBuilder.Entity("Tp4_codeFirst.Models.EntityFramework.Notation", b =>
                {
                    ...
                    b.ToTable("t_j_notation_not", "public", t =>
                        {
                            t.HasCheckConstraint("ck_not_note_0_5", "not_note >= 0 AND not_note <= 5");
                        });
                });

            modelBuilder.Entity("Tp4_codeFirst.Models.EntityFramework.Utilisateur", b =>
                {
                    b.Property<int>("UtilisateurId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Tp4_codeFirst.Models.EntityFramework.Notation", b =>
                {
                    b.HasOne("Tp4_codeFirst.Models.EntityFramework.Film", "FilmNote")
                        .WithMany("NotesFilm")
                    ...
                    b.HasOne("Tp4_codeFirst.Models.EntityFramework.Utilisateur", "UtilisateurNotant")
